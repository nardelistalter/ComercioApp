...
<div class="container">
    <form action="/funcionario" method="post"  role="form" data-toggle="validator" >
        ...
        <div class="form-group col-xs-4">
            ...
            <input type="date" name="nascimento" id="nascimento" class="form-control" value="${obj.nascimento}" required="true"/>  
        </div>
        <div class="form-group col-xs-4">
        ...
        <div class="form-group col-xs-4">
            ...
            <input type="date" name="admissao" id="admissao" class="form-control" value="${obj.admissao}" required="true"/>                                   
            <label for="demissao" class="control-label col-xs-4">Demissao:</label>
            <input type="date" name="demissao" id="demissao" class="form-control" value="${obj.demissao}"/>  
        </div>
        <div class="form-group col-xs-4">
        ...
        <div class="form-group col-xs-4">
            ...
            <input type="password" name="salario" id="senha" class="form-control" value="${obj.senha}" required="true"/>  
        </div>
        <br></br>
